...
function emptyProduct(order: number): EmployeePensionProductInput {
  return { productType: 1, policyNumber: "", fundExternalKey: "", fundCode: "", fundName: "", fundCompanyName: "", salary: 0, salaryAllocationType: 1, salaryAllocationValue: null, allocationOrder: order, reportingType: "שוטף", salaryLayer: "רובד 1", section14: false, section14StartDate: null, isActive: true, effectiveFrom: today(), effectiveTo: null, institutionalBody: "", manufacturer: "", employerContributions: components.map(({ value }) => ({ component: value, percentage: 0 })), employeeContributions: components.map(({ value }) => ({ component: value, percentage: 0 })) };
}
...
const missingLabels: Record<string, string> = { policyNumber: "מספר פוליסה", fund: "קופה", institutionalBody: "גוף מוסדי", manufacturer: "יצרן", section14StartDate: "תחילת סעיף 14", salaryAllocationValue: "ערך הקצאת שכר", contributions: "אחוזי הפקדה" };
